<!DOCTYPE html>
    ...
    <head>
        ...
        -->
        <link href="{{ URL::asset("/bower_components/AdminLTE/dist/css/skins/_all-skins.min.css")}}" rel="stylesheet" type="text/css" />
    ...
    <body class="skin-blue-light boxed sidebar-mini">
    <div class="wrapper">
